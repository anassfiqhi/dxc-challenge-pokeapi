...
const PokemonTypePill: React.FC<PokemonTypePillProps> = ({ pokemonType, compact }) => {
    ...
    return (
        <div
            className={`pokemon-type-pill ${compact ? "pokemon-type-pill--compact" : ""
                } ${classModifier}`}
